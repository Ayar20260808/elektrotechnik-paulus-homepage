# -*- coding: utf-8 -*-
"""Stempelt Logo und Fusszeile auf jede Seite eines Kundendokuments.

Ablauf:
  1) wkhtmltopdf --enable-local-file-access --margin-top 34mm --margin-bottom 26mm \
       --margin-left 16.1mm --margin-right 16.1mm dokument-basis.html inhalt.pdf
...
# --- je Angebot anpassen -------------------------------------------------
DOKUMENTNR  = "XXX-XXXXX"   # z. B. ANG-10196 oder RE-10245
CONTENT_PDF = "inhalt.pdf"
LOGO_PATH   = "../marke/logo-quer-farbe@2400.png"
OUT_PDF     = "dokument.pdf"
# -------------------------------------------------------------------------
...
def draw_page(c, seite, seiten_gesamt):
    ...
    c.drawString(MARGIN_L, y, DOKUMENTNR)
